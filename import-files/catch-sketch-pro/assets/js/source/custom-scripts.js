...
jQuery(function($){
	...
	function initMainNavigation( container ) {
		...
		var dropdownToggle = $( '<button />', { 'class': 'dropdown-toggle', 'aria-expanded': false })
			.append( catchSketchScreenReaderText.icon )
			.append( $( '<span />', { 'class': 'screen-reader-text', text: catchSketchScreenReaderText.expand }) );
		...
		container.find( '.dropdown-toggle' ).click( function( e ) {
			...
			// jscs:enable
			screenReaderSpan.text( screenReaderSpan.text() === catchSketchScreenReaderText.expand ? catchSketchScreenReaderText.collapse : catchSketchScreenReaderText.expand );
		} );
	}
