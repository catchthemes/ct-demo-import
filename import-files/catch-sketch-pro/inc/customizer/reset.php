	...
	final class Catch_Sketch_Customizer_Reset {
		...
		public function customize_controls_print_scripts() {
			...
			wp_localize_script( 'catch-sketch-customizer-reset', 'catchSketchCustomizerReset', array(
				'reset'          => esc_html__( 'Reset', 'catch-sketch-pro' ),
				'confirm'        => esc_html__( "Caution: Reset all settings to default. Process is irreversible.", 'catch-sketch-pro' ),
				'nonce'          => array(
					'reset' => wp_create_nonce( 'catch-sketch-customizer-reset' ),
				),
				'resetSection'   => esc_html__( 'Reset section', 'catch-sketch-pro' ),
				'confirmSection' => esc_html__( "Caution: Reset section settings to default. Process is irreversible.", 'catch-sketch-pro' ),
			) );
		}
		...
		public function ajax_customizer_reset() {
			...
			if ( 'footer_options' === $_POST['section'] ) {
				remove_theme_mod( 'catch_sketch_footer_content' );
			}
			...
			if ( 'sorter' === $_POST['section'] ) {
				remove_theme_mod( 'catch_sketch_sections_sort' );
			}
